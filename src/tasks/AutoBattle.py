...
class AutoBattle(BaseTask):
    ...
    def run(self):
        ...
        self.model = YOLO("E:/youxikkkkkkk/ok_game/runs/detect/runs/monster_v2-3/weights/best.pt")

        tpl = cv2.imread("E:/youxikkkkkkk/ok_game/tpl.png")
        zero_tpl = cv2.imread("E:/youxikkkkkkk/ok_game/zero.png")
        retry_tpl = cv2.imread("E:/youxikkkkkkk/ok_game/retry.png")
